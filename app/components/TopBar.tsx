        ...
        <nav className="relative flex w-full items-center justify-between py-4 px-6">
            ...
            {location.pathname === "/dashboard" && (
                <div className="pointer-events-none absolute left-1/2 -translate-x-1/2">
                    <div className="pointer-events-auto flex items-center gap-1.5 rounded-lg border border-border/30 bg-bg-100/60 px-3 py-2 shadow-sm transition focus-within:ring-1 focus-within:ring-primary-500/60">
