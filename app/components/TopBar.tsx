        ...
        <nav className="relative flex w-full items-center justify-between px-6 py-4">
            ...
            {location.pathname === "/dashboard" && (
                <div className="pointer-events-none absolute left-1/2 -translate-x-1/2">
                    <div className="pointer-events-auto flex items-center gap-1.5 rounded-lg border border-transparent bg-bg-200/60 px-3 py-2 transition focus-within:ring-1 focus-within:ring-primary-500/60">
